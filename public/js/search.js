...
(function webpackUniversalModuleDefinition(root, factory) {
                                ...
                                if (this.currentState !== this.prevState) {
                                    ...
                                    if (
                                        ...
                                        if (this.isSelectElement) {
                                            ...
                                            var activeGroups =
                                                this.store.getGroupsFilteredByActive();
                                            var activeChoices =
                                            ...
                                            var activeItems =
                                                this.store.getItemsFilteredByActive();
	    ...
	    =============================================*/
                        ...
                        },
                        {
                            ...
                            value: function _selectPlaceholderChoice() {
                                var placeholderChoice =
                                    this.store.getPlaceholderChoice();
                            ...
                            value: function _ajaxCallback() {
                                ...
                                return function (results, value, label) {
                                    ...
                                    if (
                                        ...
                                        parsedResults.forEach(function (
                                            result
                                        ) {
                                            if (result.choices) {
                        ...
                        },
                        {
                            ...
                            value: function _searchChoices(value) {
                                ...
                                if (
                                    ...
                                    var haystack =
                                        this.store.getSearchableChoices();
                                    var needle = newValue;
                            ...
                            value: function _onKeyDown(e) {
                                ...
                                var onEnterKey = function onEnterKey() {
                                    ...
                                    if (hasActiveDropdown) {
                                        e.preventDefault();
                                        var highlighted =
                                            _this16.dropdown.querySelector(
                                                "." +
                        ...
                        },
                        {
                            ...
                            value: function _createInput() {
                                ...
                                var origStyle =
                                    this.passedElement.getAttribute("style");
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                (function (global) {
                    ...
                    function BitapSearcher(pattern, options) {
                        ...
                        if (this.patternLen <= this.options.maxPatternLength) {
                            ...
                            this.patternAlphabet =
                                this._calculatePatternAlphabet();
                        }
                    }
                     ...
                     * @private
                     */
                    BitapSearcher.prototype._calculatePatternAlphabet =
                        function () {
                            var mask = {},
                                i = 0;
                    ...
                    BitapSearcher.prototype.search = function (text) {
                        ...
                        for (i = 0; i < this.patternLen; i++) {
                            ...
                            for (j = finish; j >= start; j--) {
                                charMatch =
                                    this.patternAlphabet[text.charAt(j - 1)];
	...
	*/
                    ...
                    _createClass(Store, [
                        ...
                        },
                        {
                            ...
                            value: function getSearchableChoices() {
                                var filtered =
                                    this.getChoicesFilteredBySelectable();
                        ...
                        },
                        {
                            ...
                            value: function getChoiceById(id) {
                                if (id) {
                                    var choices =
                                        this.getChoicesFilteredByActive();
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var _combineReducers2 =
                    _interopRequireDefault(_combineReducers);
                ...
                var _applyMiddleware2 =
                    _interopRequireDefault(_applyMiddleware);
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var _symbolObservable2 =
                    _interopRequireDefault(_symbolObservable);
            ...
            /***/ function (module, exports) {
                ...
                var highlightItem = (exports.highlightItem =
                    function highlightItem(id, highlighted) {
                        return {
                            type: "HIGHLIGHT_ITEM",
                            id: id,
                ...
                var filterChoices = (exports.filterChoices =
                    function filterChoices(results) {
                        return {
                            type: "FILTER_CHOICES",
                            results: results,
                        };
                ...
                var clearChoices = (exports.clearChoices =
                ...
                var setIsLoading = (exports.setIsLoading =
            ...
            /***/ function (module, exports) {
                 ...
                 */
                var generateChars = (exports.generateChars =
                 ...
                 */
                var findAncestor = (exports.findAncestor =
                 ...
                 */
                var getAdjacentEl = (exports.getAdjacentEl =
                    function getAdjacentEl(startEl, className) {
                        var direction =
                 ...
                 * @return
                 */
                var addAnimation = (exports.addAnimation =
                        ...
                        if (value) {
                            ...
                            if (
                                ...
                                if (inputStyle) {
                                    ...
                                    testEl.style.fontFamily =
                                        inputStyle.fontFamily;
                                    testEl.style.fontWeight =
                                        inputStyle.fontWeight;
                                    testEl.style.fontStyle =
                            ...
                            if (
                                value &&
                                testEl.offsetWidth !== input.offsetWidth
                            ) {
